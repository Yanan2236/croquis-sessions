...
export const SessionDonePage = () => {
  ...
  return (
    <>
      <Seo
        title="クロッキー完了"
        description="クロッキーセッションが完了しました。記録を振り返り、次の練習につなげましょう。"
      />
        ...
        <div className={styles.sheet}>
          ...
          <main className={styles.main} aria-label="完了内容">
            ...
            <div className={styles.actions} aria-label="次の操作">
              <button className={styles.primaryButton} type="button" onClick={() => navigate(`/app/sessions/new`)}>
                もう一回描く
              </button>
              <button className={styles.secondaryButton} type="button" onClick={() => navigate("/app/sessions")}>
                一覧へ戻る
              </button>
            </div>
          </main>
